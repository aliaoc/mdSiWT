...
!------decreased down to 100 as well. One should chek it on.
      ...
      Parameter (nxnodes = 16)            ! number of nodes in x direction
      Parameter (nynodes = 16)            ! number of nodes in y direction
      Parameter (nznodes = 1)            ! number of nodes in z direction
      Parameter (nnodes=nxnodes*nynodes*nznodes)   ! total number of nodes

      Parameter (LPMX0 = 26000000)       !Maximum # of particles in zeros node
...
!---- Fundamental constants ----------------------------------------------
      ...
      Parameter (beta_fix = 0.30158d0)   ! 11651d0)     ! cooupling of the plasmon to the surface 
      Parameter (delta_fix = 238.68d0)           ! Incident angle of the laser pulse
